          ...
          <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="nk-int-st">
                  ...
                  <input class="form_input" type="text" name="nombre" id="nombre" placeholder="Nombre del cliente">
              </div>
            </div>
          </div>
          <br>
          <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="nk-int-st">
                  ...
                  <input class="form_input" type="text" name="telefono" id="telefono" placeholder="Telefono del cliente">
              </div>
            </div>
          </div>
          <br>
          <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="nk-int-st">
                      ...
                      <input class="form_input" type="text" name="direccion" id="direccion" placeholder="Dirección de entrega">
                  </div>
                </div>
          </div>
          <br>
          <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="nk-int-st">
                      ...
                      <input class="form_input" type="text" name="referencia" id="referencia" placeholder="Referencia del lugar">
                  </div>
                </div>
          </div>
          <br>
          <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" id="divEfectivo">
                    <div class="nk-int-st">
                      ...
                      <input class="form_input" type="text"  name="efectivo" id="efectivo" value=0 required="required">
                  </div>
                </div>
          </div>
          <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12">
            <button id="confirmPedido" class="btn btn-success btn-block btn-lg">Agregar Pedido</button>
          </div>
        </div>
      </div>
