        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="data-table-list">
                <div class="table-responsive">
                    <table id="tablaMotorizados" class="table table-striped">
...
<div class="modal fade" id="motorizadoModal" role="dialog">
<form id="formularioDatos" method="POST">
    <div class="modal-dialog modal-large">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Datos del Motorizado</h5>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="nk-int-st">
                                              ...
                                              <input type="text" id="nombre" name="nombre" class="form-control input-sm" placeholder="Nombre del motorizado">
                                            </div>
                                        </div>
                                    </div>
                                </div>
